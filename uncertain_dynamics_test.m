...
mu_model_uncertainty=0;
sigma_model_uncertainty=0.0;
...
system_uncrtainty=normrnd(mu_model_uncertainty,sigma_model_uncertainty,size(x));
measurement_noise=normrnd(mu_measurment_uncertainty,sigma_measurment_uncertainty,size(y));
